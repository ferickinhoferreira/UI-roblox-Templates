...
function finity.new(theme_name, gprojectName, thinProject)
	local finityObject = {}
	...
	if tostring(theme_name):lower() == "light" or theme_name == nil then
        theme = finity.light_theme
    elseif tostring(theme_name):lower() == "dark" then
